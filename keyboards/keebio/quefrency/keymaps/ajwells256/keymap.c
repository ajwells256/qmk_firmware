...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all(
    ...
    KC_F9,   KC_F10,   KC_LCTL,  KC_LGUI, KC_LALT, KC_SPC, MO(_FN1),   KC_BSPC,      _______, KC_SPC,  MO(_FN1), KC_RCTL, TG(_TRAINING), _______, _______, _______
  ),

  [_TRAINING] = LAYOUT_all(
    _______, _______, _______, _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,  _______,  _______,  _______,  KC_BSPC, _______,
  ...
  [_FN1] = LAYOUT_all(
    ...
    _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______, _______, _______, _______, BL_DOWN,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, BL_BRTG,
    _______, _______, _______, _______, _______, _______, _______, KC_DEL, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_END
  )
};
